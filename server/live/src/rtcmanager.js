...
//the TURN credentials are generated on demand by the google gateway and go stale after 24 hours
//however the stuns are public and will work forever
//to get fresh TURN credentials, run wget --referer=https://appr.tc --method=POST https://networktraversal.googleapis.com/v1alpha/iceconfig?key=AIzaSyA2WoxRAjLTwrD7upuk9N2qdlcOch3D2wU 
//from the command line. due to the need to spoof the referer, it cannot be done within the browser.
//
//the simple answer is to run this client on your local host, and update the values yourself ;)
const peerConfig =  
{
    "iceServers":[
